...
<h1 align="center" style="margin: 20px 30px 0px 30px; font-weight: bold;">xise</h1>
...
# JWT配置
JWT_SECRET=xise_secret_key_2025
JWT_EXPIRES_IN=7d
...
[![Star History Chart](https://api.star-history.com/svg?repos=/dfgdsgfd/xisqky&type=Date&theme=dark)](https://github.com//dfgdsgfd/xisqky)
